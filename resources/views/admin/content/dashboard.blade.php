                    ...
                    <div class="panel">
                        ...
                        <div class="panel-chart">
                            ...
                            <div class="chart--stats style--3">
                                <ul class="nav">
                                    <li>
                                        <p data-trigger="sparkline" data-type="bar" data-width="5" data-height="38"
                                            data-color="#2bb3c0">0,5,9,7,12,15,12,5</p>
                                    ...
                                    <li>
                                        <p data-trigger="sparkline" data-type="bar" data-width="5" data-height="38"
                                            data-color="#e16123">0,15,12,5,5,9,7,12</p>
                ...
                <div class="col-xl-3">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <!-- Vector Map Start -->
                            <div class="vector--map" data-trigger="jvectorMap"
                                ...
                                <ul class="list-group" data-trigger="scrollbar">
                                    <li class="list-group-item">
                                        <label class="todo--label">
                                            <input type="checkbox" name="todo_id" value="1" class="todo--input"
                                                checked>
                                    ...
                                    <li class="list-group-item">
                                        <label class="todo--label">
                                            <input type="checkbox" name="todo_id" value="3" class="todo--input"
                                                checked>
                            ...
                            <div class="cd-horizontal-timeline">
                                <div class="timeline">
                                    <div class="events-wrapper">
                                        <div class="events">
                                            <ol>
                                                <li><a href="#" data-date="10/11/2014"
                                                        class="older-event">Meeting</a></li>
                                ...
                                <div class="events-content">
                                    <ol>
                                        <li data-date="10/11/2014">
                                            ...
                                            <div class="desc">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure maiores
                                                    nulla aspernatur. Nemo doloremque a deserunt quas, sunt, voluptate
                                                    inventore iure? Deserunt sit omnis quas eligendi, nulla architecto alias
                                                    officia.</p>
                                            </div>
                                        </li>
                ...
                <div class="col-xl-6">
                    <div class="panel">
                        <div class="profile--panel">
                            ...
                            <div class="bio">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo ratione vitae aliquid
                                    aliquam provident nostrum itaque quam minima molestias.</p>
                            </div>
                        ...
                        <div class="feeds-panel">
                            <ul class="nav">
                                ...
                                <li>
                                    ...
                                    <span class="text"><a href="#">John Doe</a> Commented on <a
                                            href="#">News #123</a></span>
                                </li>
                                <li>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="panel">
                        ...
                        <div class="comments-panel">
                            ...
                            <div class="nav">
                                <a href="#" class="next btn-link">Older Comments <i
