    ...
    <section id="content">
        <div class="container">
            <div class="span12">
                ...
                @if ($dataPosyandu->isNotEmpty())
                    <div class="row" align="center">
                        <h4 class="title" align="center"><strong>Struktur Organisasi</strong></h4>
                        <!-- Perbarui baris ini -->
                        <img src="{{ asset('images/organisasi/' . $dataPosyandu->first()->sotk) }}" alt=""
                            class="mx-auto d-block" />
                    </div>
                @endif

                <!-- Tampilkan bagian daftar anggota jika data anggota tersedia -->
                @if ($dataPosyandu->isNotEmpty() && !is_null($dataPosyandu->first()->anggota))
                    <div class="row" align="center">
                        <h4 class="title" align="center"><strong>Daftar Anggota</strong></h4>
                        <!-- Perbarui baris ini -->
                        <img src="{{ asset('images/organisasi/' . $dataPosyandu->first()->anggota) }}" alt=""
                            class="mx-auto d-block" />
                    </div>
                @endif
            </div>
